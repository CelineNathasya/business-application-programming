...
{
   public partial class FrmAddressBook4 : Form
   {
      ...
      private void QueryData(string namaQuery = "")
      {
         try
         {
            ...
            using (DALAddressBook dal =new DALAddressBook())
            {
      ...
      private void FrmAddressBook4_Load(object sender, EventArgs e)
      {
         try
         {
            QueryData();
